...
func MULADDRSHIFTCCODEMOD(value int8) (op *helpers.AdvancedOP) {
	op = &helpers.AdvancedOP{
		Action: func(state *vm.State) error {
			...
			q := helpers.DivCeil(dividend, y.Lsh(big.NewInt(1), uint(value)))
		...
		Prefix: cell.BeginCell().MustStoreSlice([]byte{0xA9, 0xB2}, 16).EndCell(),
		SerializeSuffix: func() *cell.Builder {
			return cell.BeginCell().MustStoreInt(int64(value), 8)
		},
		NameSerializer: func() string {
			return fmt.Sprintf("%d MULADDRSHIFTC#MOD", value)
		},
