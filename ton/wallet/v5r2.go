...
const _V5R2CodeHex = ""

type ConfigV5R2 struct {
	NetworkGlobalID int32
	Workchain       int8
}

type SpecV5R2 struct {
	SpecRegular
	SpecSeqno
...
func (s *SpecV5R2) BuildMessage(ctx context.Context, _ bool, _ *ton.BlockIDExt, messages []*Message) (_ *cell.Cell, err error) {
	if len(messages) > 255 {
	...
	actions, err := packV5R2Actions(messages)
	if err != nil {
...
// Pack Actions
func packV5R2Actions(messages []*Message) (*cell.Builder, error) {
